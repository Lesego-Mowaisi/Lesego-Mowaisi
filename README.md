...
|---|---|---|---|
| · Kotlin *(learning)*<br>· Jetpack Compose *(learning)*<br>· Android Studio | · JEE/MVC *(in progress)*<br>· JSP / Servlets<br>· NetBeans IDE | · DevOps *(exploring)*<br>· Linux *(exploring)*<br>· DevOps *(aspiring)* | · SQL *(used in projects)*<br>· Technical writing<br>· OOP (Java)|
...
Modules:`MOB316D (Kotline/Jetpack)` · `INT316D(Java EE Web Development)`
